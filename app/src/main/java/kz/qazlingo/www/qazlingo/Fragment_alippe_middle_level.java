...
public class Fragment_alippe_middle_level extends Fragment {
    private static final String TAG = "MainActivity";
    private static final String TITLE = "Cөздің латынша нұсқасын еңгізіңіз";
    ...
    private void  initVar(){
        ...
        tvNotification = getActivity().findViewById(R.id.alippe_middle_level_text_view_lenta);
        tvAlphabet = getActivity().findViewById(R.id.alippe_middle_level_text_view);
        btNext = getActivity().findViewById(R.id.alippe_middle_level_button);
        etAnswer = getActivity().findViewById(R.id.alippe_middle_level_edit_text);
        tvRightAnswer = getActivity().findViewById(R.id.alippe_middle_level_text_view_right_answer);
